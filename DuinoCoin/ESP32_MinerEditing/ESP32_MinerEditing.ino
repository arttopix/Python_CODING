...
const char *wifi_ssid = "Arttohome 2.4G";
// Change this to your WiFi wifi_password
const char *wifi_password = "artandsine9119";
// Change this to your Duino-Coin username
const char *username = "arttopix";
// Change this if you want a custom rig identifier
const char *rig_identifier = "VampierRig";
